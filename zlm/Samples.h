/*******************************************
Shared include file for the zlm
*******************************************/
#ifndef __GZNSCY_CY_ZLM_INCLUDE__
#define __GZNSCY_CY_ZLM_INCLUDE__
...
#define CA_CERT_PEM_FILE_EXTENSION ".crt"
...
STATUS initLocalPeer(PSampleConfiguration, PCHAR);

#ifdef __cplusplus
}
#endif

#endif /* __GZNSCY_CY_ZLM_INCLUDE__ */
